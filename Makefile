...
PARSING_MANDATORY_SRCS= $(addprefix parsing/, map_checker.c read_map.c parser_utils.c scene_checker.c scene_elements.c parser_utils2.c)
# PARSING_OBJS = $(PARSING_SRCS:.c=.o)
PARSING_BONUS_SRCS= $(addprefix parsing_bonus/, map_checker.c read_map.c parser_utils.c scene_checker.c scene_elements.c parser_utils2.c)
